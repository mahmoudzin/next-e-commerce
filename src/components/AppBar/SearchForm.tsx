        ...
        <div className="flex">
          ...
          <div className="relative w-full">
            <input
              ...
              placeholder="Search by category or by Product Name"
              required
            />
            <button
              type="submit"
              className="absolute top-0 right-0 p-2.5 text-sm font-medium h-full text-white bg-primary rounded-r-lg border border-primary hover:bg-primary focus:ring-4 focus:outline-none focus:ring-primary"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
